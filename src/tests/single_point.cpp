...
int main(int argc, char** argv) {
    ...
    // Try to read and the information out
    if (argc > 3) {
        systems[0].SetUpFromJsonMolecule(argv[3]);

        // do the print to test the loading correctly

        // assume that I got the setup correctly and overcome the fftw.h problem
    ...
    // test the reading properly or not TODO
    // test the reading and create another function to return the json!
