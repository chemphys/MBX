...
#ifndef MBNRG_3B_A1B3_C1D2_C1D2_DEG4_V1_H
#define MBNRG_3B_A1B3_C1D2_C1D2_DEG4_V1_H
...
/**
 * @file mbnrg_3b_A1B3_C1D2_C1D2_deg4_v1.h
 * @brief Contains the structure of the polynomial holder for symmetry A1B3_C1D2_C1D2
 */

/**
 * @namespace mbnrg_A1B3_C1D2_C1D2_deg4
 * @brief Encloses the structure of the polynomial holder for symmetry A1B3_C1D2_C1D2
 */
...
struct mbnrg_A1B3_C1D2_C1D2_deg4_v1 {
    // Creates an empty class
    mbnrg_A1B3_C1D2_C1D2_deg4_v1(){};
     ...
     */
    mbnrg_A1B3_C1D2_C1D2_deg4_v1(const std::string mon1, const std::string mon2, const std::string mon3);

    // Destroys the class
    ~mbnrg_A1B3_C1D2_C1D2_deg4_v1(){};

    // Polynomial for this symmetry
    typedef poly_A1B3_C1D2_C1D2_deg4_v1 polynomial;
