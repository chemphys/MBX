...
bool GetBuckParams(std::string mon_id1, std::string mon_id2, size_t index1, size_t index2,
    ...
    if (mon_id1 == "f" and mon_id2 == "h2o") {
        ...
        // Fill in (in order) the C6 and d6 coefficients
        a.push_back(7667.03);  // kcal/mol A--C
        a.push_back(9358.02);  // kcal/mol A--D
        a.push_back(4319.1);   // kcal/mol B--C
        a.push_back(4066.67);  // kcal/mol B--D
        b.push_back(3.16561);  // A^(-1) A--C
        b.push_back(2.89365);  // A^(-1) A--D
        b.push_back(2.82847);  // A^(-1) B--C
        b.push_back(3.82455);  // A^(-1) B--D
        ...
        // Fill in (in order) the C6 and d6 coefficients
        a.push_back(12831.3);  // kcal/mol A--C
        a.push_back(949.547);  // kcal/mol B--C
        a.push_back(7732.82);  // kcal/mol A--D
        a.push_back(3561.96);  // kcal/mol B--D
        b.push_back(3.75461);  // A^(-1) A--C
        b.push_back(2.0592);   // A^(-1) B--C
        b.push_back(2.81438);  // A^(-1) A--D
        b.push_back(3.37392);  // A^(-1) B--D
        ...
        // Fill in (in order) the C6 and d6 coefficients
        a.push_back(52292.2);  // kcal/mol A--C
        a.push_back(39558.0);  // kcal/mol A--D
        a.push_back(2421.07);  // kcal/mol B--C
        a.push_back(4348.09);  // kcal/mol B--D
        b.push_back(4.44254);  // A^(-1) A--C
        b.push_back(3.66679);  // A^(-1) A--D
        b.push_back(2.93568);  // A^(-1) B--C
        b.push_back(3.90113);  // A^(-1) B--D
