...
/**
 * @file poly_1b_A1B3_deg5_grad_v1.cpp
 * @brief Contains the implementation of the polynomials with gradients for symmetry A1B3
 */

/**
 * @namespace mbnrg_A1B3_deg5
 * @brief Encloses the structure of the polynomial holder for symmetry A1B3
 */
namespace mbnrg_A1B3_deg5 {
