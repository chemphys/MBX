...
#ifndef MBNRG_1B_A1B4_DEG5_V1_H
#define MBNRG_1B_A1B4_DEG5_V1_H
...
struct mbnrg_A1B4_deg5_v1 {
     ...
     */
    mbnrg_A1B4_deg5_v1(const std::string mon1);

    // Destroys the class
    ~mbnrg_A1B4_deg5_v1(){};

    // Polynomial for this symmetry
    typedef poly_A1B4_deg5_v1 polynomial;
