...
#include "poly_1b_A1B4_deg5_v1.h"

/**
 * @file poly_1b_A1B4_deg5_grad_v1.cpp
 * @brief Contains the implementation of the polynomials with gradients for symmetry A1B4
 */
...
double poly_A1B4_deg5_v1::eval(const double x[10], const double a[207], double g[10]) {
    const double t1 = a[1];
    const double t2 = a[8];
    const double t3 = a[21];
    const double t4 = a[171];
    const double t7 = x[9];
    const double t5 = t7 * t4;
    const double t6 = a[38];
    const double t8 = (t5 + t6) * t7;
    const double t10 = (t3 + t8) * t7;
    const double t12 = (t2 + t10) * t7;
    const double t15 = a[5];
    const double t16 = a[25];
    const double t17 = a[89];
    const double t18 = t7 * t17;
    const double t19 = a[37];
    const double t21 = (t18 + t19) * t7;
    const double t23 = (t16 + t21) * t7;
    const double t25 = (t15 + t23) * t7;
    const double t26 = a[99];
    const double t27 = t7 * t26;
    const double t28 = a[55];
    ...
    const double t44 = a[18];
    const double t45 = a[165];
    const double t46 = t7 * t45;
    const double t47 = a[42];
    const double t49 = (t46 + t47) * t7;
    const double t51 = (t44 + t49) * t7;
    const double t52 = a[201];
    ...
    const double t79 = a[10];
    const double t80 = a[188];
    const double t81 = t7 * t80;
    const double t82 = a[52];
    const double t84 = (t81 + t82) * t7;
    const double t86 = (t79 + t84) * t7;
    const double t87 = a[110];
    ...
    const double t194 = a[164];
    const double t195 = t33 * t194;
    const double t196 = a[198];
    const double t197 = t7 * t196;
    const double t198 = a[64];
    ...
    const double t486 = a[166];
    const double t487 = t7 * t486;
    const double t488 = a[35];
    ...
    const double t677 = a[3];
    const double t678 = a[11];
    const double t679 = a[175];
    const double t680 = t7 * t679;
    const double t681 = a[39];
    const double t683 = (t680 + t681) * t7;
    const double t685 = (t678 + t683) * t7;
    const double t686 = a[126];
    const double t687 = t7 * t686;
    const double t688 = a[68];
    ...
    const double t740 = a[193];
    const double t741 = t66 * t740;
    const double t742 = a[147];
    const double t743 = t33 * t742;
    const double t744 = a[107];
    const double t745 = t7 * t744;
    const double t746 = a[33];
    ...
    const double t810 = t797 * t155;
    const double t811 = a[146];
    const double t812 = t811 * t66;
    ...
    const double t1596 = a[26];
    const double t1597 = a[157];
    const double t1598 = t7 * t1597;
    const double t1599 = a[41];
    const double t1601 = (t1598 + t1599) * t7;
    const double t1602 = t33 * t1597;
    const double t1603 = a[144];
    ...
    const double t2183 = a[120];
    const double t2184 = t2183 * t788;
    const double t2185 = a[141];
