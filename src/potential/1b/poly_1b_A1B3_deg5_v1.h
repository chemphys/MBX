...
/**
 * @file poly_1b_A1B3_deg5_v1.h
 * @brief Contains the structure of the polynomial for symmetry A1B3
 */

/**
 * @namespace mbnrg_A1B3_deg5
 * @brief Encloses the structure of the polynomial for symmetry A1B3
 */
...
struct poly_A1B3_deg5_v1 {
    ...
    /**
     * @brief Evaluates the polynomial of degree 5 for A1B3 symmetry.
     *
     * Given the linear parameters and the value of the polynomial variables,
     * evaluates the polynomial for the A1B3 symmetry.
     * @param[in] x Double array of length 6 with the variable values
     * @param[in] a Double array of 102 elements with the linear parameters of the polynomial
     ...
     * @param[in] x Double array of length 6 with the variable values
     * @param[in] a Double array of 102 elements with the linear parameters of the polynomial
     * @param[out] g Double array of length 6 that will store the gradients dP/dxi
     * @return Value of the polynomial
     */
