...
bool GetC6(std::string mon_id1, std::string mon_id2, size_t index1, size_t index2, double& out_C6, double& out_d6,
    ...
    if (mon_id1 == "h2o" && mon_id2 == "h2o") {
    ...
    } else if (mon_id1 == "ccl4" and mon_id2 == "ccl4") {
        types1.push_back(0);
        types1.push_back(1);
        types1.push_back(1);
        types1.push_back(1);
        ...
        // Fill in (in order) the C6 and d6 coefficients
        C6.push_back(273.6569);  // kcal/mol * A^(-6)  A--A
        C6.push_back(490.0401);  // kcal/mol * A^(-6)  A--B
        C6.push_back(490.0401);  // kcal/mol * A^(-6)  A--B
        C6.push_back(982.6164);  // kcal/mol * A^(-6)  B--B
        d6.push_back(2.75682);   // A^(-1) A--A
        d6.push_back(2.96515);   // A^(-1) A--B
        d6.push_back(2.96515);   // A^(-1) A--B
        d6.push_back(3.16566);   // A^(-1) B--B
