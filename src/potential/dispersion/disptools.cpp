...
bool GetC6(std::string mon_id1, std::string mon_id2, size_t index1, size_t index2, double& out_C6, double& out_d6,
    ...
    if (mon_id1 == "h2o" && mon_id2 == "h2o") {
    ...
    } else if (mon_id1 == "h2o" and mon_id2 == "so4a") {
        types1.push_back(0);
        types1.push_back(1);
        types1.push_back(1);
        ...
        // Fill in (in order) the C6 and d6 coefficients
        C6.push_back(493.9465);  // kcal/mol * A^(-6)  A--C
        C6.push_back(252.5366);  // kcal/mol * A^(-6)  A--D
        C6.push_back(240.9586);  // kcal/mol * A^(-6)  B--C
        C6.push_back(112.1187);  // kcal/mol * A^(-6)  B--D
        d6.push_back(3.16561);   // A^(-1) A--C
        d6.push_back(2.89365);   // A^(-1) A--D
        d6.push_back(2.82847);   // A^(-1) B--C
        d6.push_back(3.82455);   // A^(-1) B--D
    } else if (mon_id1 == "co3a" and mon_id2 == "h2o") {
        types1.push_back(0);
        types1.push_back(1);
        types1.push_back(1);
        types1.push_back(1);
        ...
        // Fill in (in order) the C6 and d6 coefficients
        C6.push_back(636.7827);  // kcal/mol * A^(-6)  A--C
        C6.push_back(804.8557);  // kcal/mol * A^(-6)  B--C
        C6.push_back(492.2976);  // kcal/mol * A^(-6)  A--D
        C6.push_back(534.6804);  // kcal/mol * A^(-6)  B--D
        d6.push_back(3.75461);   // A^(-1) A--C
        d6.push_back(2.0592);    // A^(-1) B--C
        d6.push_back(2.81438);   // A^(-1) A--D
        d6.push_back(3.37392);   // A^(-1) B--D
    } else if (mon_id1 == "h2o" and mon_id2 == "no3a") {
        types1.push_back(0);
        types1.push_back(1);
        types1.push_back(1);
        ...
        // Fill in (in order) the C6 and d6 coefficients
        C6.push_back(191.0362);  // kcal/mol * A^(-6)  A--C
        C6.push_back(231.8642);  // kcal/mol * A^(-6)  A--D
        C6.push_back(89.9375);   // kcal/mol * A^(-6)  B--C
        C6.push_back(102.7384);  // kcal/mol * A^(-6)  B--D
        d6.push_back(4.44254);   // A^(-1) A--C
        d6.push_back(3.66679);   // A^(-1) A--D
        d6.push_back(2.93568);   // A^(-1) B--C
        d6.push_back(3.90113);   // A^(-1) B--D
