...
#ifndef MBNRG_2B_A1B2Z2_C1D4_DEG4_V1_H
#define MBNRG_2B_A1B2Z2_C1D4_DEG4_V1_H
...
/**
 * @file mbnrg_2b_A1B2Z2_C1D4_deg4_v1.h
 * @brief Contains the structure of the polynomial holder for symmetry A1B2Z2_C1D4
 */

/**
 * @namespace mbnrg_A1B2Z2_C1D4_deg4
 * @brief Encloses the structure of the polynomial holder for symmetry A1B2Z2_C1D4
 */
...
struct mbnrg_A1B2Z2_C1D4_deg4_v1 {
    // Creates an empty class
    mbnrg_A1B2Z2_C1D4_deg4_v1(){};
     ...
     */
    mbnrg_A1B2Z2_C1D4_deg4_v1(const std::string mon1, const std::string mon2);

    // Destroys the class
    ~mbnrg_A1B2Z2_C1D4_deg4_v1(){};

    // Polynomial for this symmetry
    typedef poly_A1B2Z2_C1D4_deg4_v1 polynomial;
...
urns a vector with them.
   ...
   private:
    ...
    double m_k_x_inter_C_Z_0;
    double m_k_x_intra_D_D_1;
    double m_k_x_inter_D_Z_0;
