...
double get_2b_energy(std::string mon1, std::string mon2, size_t nm, std::vector<double> xyz1,
    ...
    if (mon1 == "h2o" and mon2 == "h2o") {
        ...
        energy = pot.eval(xyz2.data(), xyz1.data(), nm);
    } else if (mon1 == "h2o" and mon2 == "so4a") {
        mbnrg_A1B2Z2_C1D4_deg4::mbnrg_A1B2Z2_C1D4_deg4_v1 pot(mon1, mon2);
        return pot.eval(xyz1.data(), xyz2.data(), nm);
    } else if (mon1 == "co3a" and mon2 == "h2o") {
        mbnrg_A1B2Z2_C1D3_deg4::mbnrg_A1B2Z2_C1D3_deg4_v1 pot(mon2, mon1);
        return pot.eval(xyz2.data(), xyz1.data(), nm);
    } else if (mon1 == "h2o" and mon2 == "no3a") {
        mbnrg_A1B2Z2_C1D3_deg4::mbnrg_A1B2Z2_C1D3_deg4_v1 pot(mon1, mon2);
        return pot.eval(xyz1.data(), xyz2.data(), nm);
